...
var AuthLayoutComponent = class _AuthLayoutComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AuthLayoutComponent, selectors: [["app-auth-layout"]], decls: 1, vars: 0, template: function AuthLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AuthLayoutComponent, { className: "AuthLayoutComponent" });
})();
...
var LoginPageComponent = class _LoginPageComponent {
  ...
  static {
    this.\u0275fac = function LoginPageComponent_Factory(t) {
      return new (t || _LoginPageComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginPageComponent, selectors: [["app-login-page"]], decls: 17, vars: 8, consts: [[3, "ngSubmit", "formGroup"], [1, "surface-0"], [1, "flex", "align-items-center", "justify-content-between", "flex-column", "h-screen"], [1, "flex", "flex-column", "align-items-center", "justify-content-center", "w-full", "md:w-4", "h-full", "text-center", "py-6", "px-4"], [1, "mb-3", 3, "routerLink"], ["src", "assets/logo/main-logo.png", "alt", "logo.svg", "width", "50%"], [1, "flex", "flex-column"], [1, "p-input-icon-left", "w-full", "mb-4"], [1, "pi", "pi-envelope"], ["id", "email", "name", "username", "formControlName", "username", "type", "text", "pInputText", "", "placeholder", "Email", 1, "w-full", "md:w-25rem", "text-color-secondary", "surface-50", "border-200"], [1, "pi", "pi-lock", "z-2"], ["id", "password", "name", "password", "formControlName", "password", "placeholder", "Password", "inputStyleClass", "w-full md:w-25rem text-color-secondary surface-50 border-200", 3, "inputStyle", "toggleMask", "feedback"], ["pButton", "", "pRipple", "", "type", "submit", "label", "Login", 1, "w-full", "mb-4", 3, "disabled"], [1, "flex", "flex-wrap", "align-items-center", "pb-8", "px-4"], [1, "m-0", "mr-5", 2, "line-height", "22px"]], template: function LoginPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(8, "i", 8)(9, "input", 9);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(10, "span", 7);
        \u0275\u0275element(11, "i", 10)(12, "p-password", 11);
        \u0275\u0275elementEnd();
        \u0275\u0275element(13, "button", 12);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(14, "div", 13)(15, "h4", 14);
        \u0275\u0275text(16, " Novedades Maritex App ");
        \u0275\u0275elementEnd()()()()();
      }
      if (rf & 2) {
        ...
        \u0275\u0275advance(8);
        \u0275\u0275property("inputStyle", \u0275\u0275pureFunction0(7, _c12))("toggleMask", true)("feedback", false);
        \u0275\u0275advance();
        \u0275\u0275property("disabled", ctx.myForm.invalid);
      }
    }, dependencies: [RouterLink, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, ButtonDirective, InputText, Password] });
  }
};
(() => {
...
var RegisterPageComponent = class _RegisterPageComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RegisterPageComponent, selectors: [["app-register-page"]], decls: 2, vars: 0, template: function RegisterPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "p");
        \u0275\u0275text(1, "register-page works!");
        \u0275\u0275elementEnd();
      }
    } });
  }
...
//# sourceMappingURL=auth.module-CPPXJAGE.js.map

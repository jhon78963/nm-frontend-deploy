...
var FileApiService = class _FileApiService {
  constructor(http) {
    this.http = http;
    this.BASE_FILE_URL = BASE_FILE_URL;
  }
  post(path, body, headers) {
    return this.http.post(`${this.BASE_FILE_URL}/${path}`, body, {
      headers
    });
  }
  delete(path, headers) {
    return this.http.delete(`${this.BASE_FILE_URL}/${path}`, { headers });
  }
  static {
    this.\u0275fac = function FileApiService_Factory(t) {
      return new (t || _FileApiService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FileApiService, factory: _FileApiService.\u0275fac, providedIn: "root" });
  }
};

// src/app/services/file.service.ts
var FileService = class _FileService {
  constructor(apiService, fileApiService) {
    this.apiService = apiService;
    this.fileApiService = fileApiService;
    this.BASE_STORAGE_URL = BASE_STORAGE_URL;
    this.images = [];
    this.images$ = new BehaviorSubject(this.images);
  }
  callGetList(productId) {
    return this.apiService.get(`products/${productId}/images`).pipe(debounceTime(600), map((images) => {
  ...
  saveMultipleImage(productId, images) {
  ...
  removeMultipleImage(productId, path) {
  ...
  static {
    this.\u0275fac = function FileService_Factory(t) {
      return new (t || _FileService)(\u0275\u0275inject(ApiService), \u0275\u0275inject(FileApiService));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FileService, factory: _FileService.\u0275fac, providedIn: "root" });
  }
};

// src/app/private/inventories/products/pages/form/ecommerce/ecommerce-form.component.ts
var _c02 = () => ["/inventories/products"];
var _c12 = () => [];
function EcommerceFormComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 1)(1, "div", 2)(2, "div", 3)(3, "div", 4)(4, "button", 5);
    \u0275\u0275listener("click", function EcommerceFormComponent_Conditional_0_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(8, "app-input-text", 9);
    \u0275\u0275elementStart(9, "span", 10);
    \u0275\u0275text(10, " * Dejar en blanco para desactivar descuento ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(11, "div", 8);
    \u0275\u0275element(12, "app-input-text", 11);
    \u0275\u0275elementStart(13, "span", 10);
    \u0275\u0275text(14, " * Dejar en blanco para desactivar descuento ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(15, "div", 12)(16, "app-input-image", 13);
    \u0275\u0275pipe(17, "async");
    \u0275\u0275listener("selectedFilesChange", function EcommerceFormComponent_Conditional_0_Template_app_input_image_selectedFilesChange_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.getFormData($event));
    })("imagesToDelete", function EcommerceFormComponent_Conditional_0_Template_app_input_image_imagesToDelete_16_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.imagesToDelete($event));
    });
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    let tmp_8_0;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275classMap("col-12 mt-0" + (!ctx_r1.stepper ? " card" : ""));
    ...
    \u0275\u0275advance(11);
    \u0275\u0275property("productId", ctx_r1.productId)("imageSaved", ctx_r1.imageSaved)("imagesSaved", ctx_r1.imagesSaved)("images", (tmp_8_0 = \u0275\u0275pipeBind1(17, 9, ctx_r1.images)) !== null && tmp_8_0 !== void 0 ? tmp_8_0 : \u0275\u0275pureFunction0(12, _c12));
  }
}
var EcommerceFormComponent = class _EcommerceFormComponent {
  constructor(router, route, formBuilder, fileService, productsService, loadingService, progressSpinnerService) {
    this.router = router;
    this.route = route;
  ...
  getImages() {
    return __async(this, arguments, function* (productId = this.productId) {
  ...
  getFormData(inputImage) {
    ...
    if (inputImage.multiply && Array.isArray(inputImage.images)) {
      inputImage.images.forEach((file) => {
    ...
    this.fileService.createImage(formData, inputImage.multiply).subscribe({
      next: (resp) => {
        if (resp.image) {
          this.fileService.saveImage(this.productId, { image: resp.image, size, name }).subscribe({
            next: () => {
        ...
        if (resp.images) {
          this.fileService.saveMultipleImage(this.productId, {
            image: resp.images,
            size: sizes,
            name: names
          }).subscribe({
  ...
  imagesToDelete(collection) {
    ...
    if (collection.multiply) {
      this.fileService.removeMultipleImage(this.productId, collection.images).subscribe({
        next: () => this.progressSpinnerService.hidden(),
        error: () => this.progressSpinnerService.hidden()
      });
    } else {
      this.fileService.deleteImage(collection.images).subscribe({
        next: () => {
          this.fileService.removeImage(this.productId, collection.images).subscribe({
            next: () => {
              this.progressSpinnerService.hidden();
            }
          });
  ...
  static {
    this.\u0275fac = function EcommerceFormComponent_Factory(t) {
      return new (t || _EcommerceFormComponent)(\u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(FileService), \u0275\u0275directiveInject(ProductsService), \u0275\u0275directiveInject(LoadingService), \u0275\u0275directiveInject(ProgressSpinnerService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EcommerceFormComponent, selectors: [["app-products-ecommerce-form"]], standalone: true, features: [\u0275\u0275ProvidersFeature([MessageService]), \u0275\u0275StandaloneFeature], decls: 2, vars: 1, consts: [[3, "formGroup", "class"], [3, "formGroup"], [1, "w-full"], [1, "flex", "justify-content-center", "md:justify-content-end", "gap-2", "mb-3"], [1, "flex", "flex-wrap", "justify-content-center", "gap-2"], ["pButton", "", "pRipple", "", "label", "Guardar", "icon", "pi pi-save", "severity", "secondary", "size", "small", 1, "btn-menu", "w-9rem", 3, "click", "disabled"], ["pButton", "", "pRipple", "", "label", "Regresar", "icon", "pi pi-arrow-left", "severity", "help", "size", "small", 1, "btn-menu-back", "w-9rem", 3, "routerLink"], [1, "p-fluid", "p-formgrid", "grid"], [1, "field", "col-12", "md:col-6"], ["placeholder", "Ingrese descuento por porcentaje (%)", "label", "Descuento por porcentaje", "controlName", "percentageDiscount", "pKeyFilter", "num"], [1, "discount-label"], ["placeholder", "Ingrese descuento por efectivo", "label", "Descuento por efectivo (S/)", "controlName", "cashDiscount", "pKeyFilter", "num"], [1, "field", "col-12"], [3, "selectedFilesChange", "imagesToDelete", "productId", "imageSaved", "imagesSaved", "images"]], template: function EcommerceFormComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, EcommerceFormComponent_Conditional_0_Template, 18, 13, "form", 0);
        \u0275\u0275element(1, "p-toast");
      }
      if (rf & 2) {
      ...
      ImageModule,
      TooltipModule
    ], styles: ["\n\n.discount-label[_ngcontent-%COMP%] {\n  font-size: 10px;\n  font-weight: 500;\n  color: #6b6b6b;\n}\n.btn-menu[_ngcontent-%COMP%] {\n  background-color: #dfe3e8;\n  border: 1px solid #dfe3e8;\n  color: #475569;\n  border-radius: 5px;\n  height: 39px;\n}\n.btn-menu-back[_ngcontent-%COMP%] {\n  background-color: #ffb340;\n  border: 1px solid #ffb340;\n  color: #000;\n  border-radius: 5px;\n  height: 39px;\n}\n/*# sourceMappingURL=ecommerce-form.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EcommerceFormComponent, { className: "EcommerceFormComponent" });
})();
export {
  EcommerceFormComponent
};
//# sourceMappingURL=ecommerce-form.component-ASKO45DS.js.map
